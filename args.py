...
def get_args():
    ...
    parser.add_argument('--wd', type=float, default=0.0005, help='Weight decay') # Added for trainer.py
    
    # Output parameters
    parser.add_argument('--out_dir', type=str, default='./checkpoints', help='Where to save the model') # Added for trainer.py
    
    # Device configuration
    parser.add_argument('--device', type=str, default='cpu', help='Device to use (mps or cpu)')
    
    parser.add_argument('--new_images_dir', type=str, default='./Data/new_images', help='Directory containing new images for evaluation')
    parser.add_argument('--model_path', type=str, default='./checkpoints/best_model.pth', help='Path to the trained model for evaluation')
